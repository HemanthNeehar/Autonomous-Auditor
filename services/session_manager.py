...
# Load .env relative to the project root (src_v2's parent)
...
def create_session_service(
    ...
    agent_engine_id = agent_engine_id or os.environ.get("AGENT_ENGINE_ID", None)

    if use_vertex is None:
        use_vertex = bool(agent_engine_id)
